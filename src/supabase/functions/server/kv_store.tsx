...
/* Table schema:
CREATE TABLE kv_store_0f9c0abd (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/xomvnhxjzuitdawspund/database/tables
...
export const set = async (key: string, value: any): Promise<void> => {
  ...
  const { error } = await supabase.from("kv_store_0f9c0abd").upsert({
    key,
    value
  });
  if (error) {
